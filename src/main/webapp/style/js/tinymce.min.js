...
!function (e, t) {
    ...
    var s = {}, l = "tinymce/dom/Sizzle", c = "tinymce/html/Styles", d = "tinymce/dom/EventUtils",
        u = "tinymce/dom/TreeWalker", f = "tinymce/utils/Tools", p = "tinymce/dom/Range", m = "tinymce/html/Entities",
        ...
        T = "tinymce/utils/VK", R = "tinymce/dom/ControlSelection", A = "tinymce/dom/RangeUtils",
        B = "tinymce/dom/Selection", L = "tinymce/fmt/Preview", D = "tinymce/Formatter", M = "tinymce/UndoManager",
        H = "tinymce/EnterKey", P = "tinymce/ForceBlocks", O = "tinymce/EditorCommands", I = "tinymce/utils/URI",
        F = "tinymce/utils/Class", z = "tinymce/ui/Selector", W = "tinymce/ui/Collection", V = "tinymce/ui/DomUtils",
        U = "tinymce/ui/Control", q = "tinymce/ui/Factory", j = "tinymce/ui/KeyboardNavigation",
        $ = "tinymce/ui/Container", K = "tinymce/ui/DragHelper", Y = "tinymce/ui/Scrollable", G = "tinymce/ui/Panel",
        X = "tinymce/ui/Movable", J = "tinymce/ui/Resizable", Q = "tinymce/ui/FloatPanel", Z = "tinymce/ui/Window",
        et = "tinymce/ui/MessageBox", tt = "tinymce/WindowManager", nt = "tinymce/utils/Quirks",
        rt = "tinymce/utils/Observable", it = "tinymce/Shortcuts", ot = "tinymce/Editor", at = "tinymce/utils/I18n",
        st = "tinymce/FocusManager", lt = "tinymce/EditorManager", ct = "tinymce/LegacyInput", dt = "tinymce/utils/XHR",
        ut = "tinymce/utils/JSON", ft = "tinymce/utils/JSONRequest", pt = "tinymce/utils/JSONP",
        mt = "tinymce/utils/LocalStorage", ht = "tinymce/Compat", gt = "tinymce/ui/Layout",
        vt = "tinymce/ui/AbsoluteLayout", yt = "tinymce/ui/Tooltip", bt = "tinymce/ui/Widget", Ct = "tinymce/ui/Button",
        xt = "tinymce/ui/ButtonGroup", wt = "tinymce/ui/Checkbox", _t = "tinymce/ui/PanelButton",
        Nt = "tinymce/ui/ColorButton", Et = "tinymce/ui/ComboBox", kt = "tinymce/ui/Path",
        St = "tinymce/ui/ElementPath", Tt = "tinymce/ui/FormItem", Rt = "tinymce/ui/Form", At = "tinymce/ui/FieldSet",
        Bt = "tinymce/ui/FilePicker", Lt = "tinymce/ui/FitLayout", Dt = "tinymce/ui/FlexLayout",
        Mt = "tinymce/ui/FlowLayout", Ht = "tinymce/ui/FormatControls", Pt = "tinymce/ui/GridLayout",
        Ot = "tinymce/ui/Iframe", It = "tinymce/ui/Label", Ft = "tinymce/ui/Toolbar", zt = "tinymce/ui/MenuBar",
        Wt = "tinymce/ui/MenuButton", Vt = "tinymce/ui/ListBox", Ut = "tinymce/ui/MenuItem", qt = "tinymce/ui/Menu",
        jt = "tinymce/ui/Radio", $t = "tinymce/ui/ResizeHandle", Kt = "tinymce/ui/Spacer",
        Yt = "tinymce/ui/SplitButton", Gt = "tinymce/ui/StackLayout", Xt = "tinymce/ui/TabPanel",
        Jt = "tinymce/ui/TextBox", Qt = "tinymce/ui/Throbber";
    r(l, [], function () {
        ...
        return function (i, o) {
            ...
            i = i || {}, s.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var s = this, l, c = 0, d, u, f = [], p, m, h, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, L, D, M,
                    H, P, O, I = 0, F = t.decode, z, W = n.makeMap("src,href"), V = /(java|vb)script:/i;
        ...
        return function (r, i) {
            ...
            var C = i.dom, x = t.each, w, _, N, E, k, S, T, R, A, B, L, D, M, H, P, O = i.getDoc(), I = document,
                F = n.ie && n.ie < 11;
            N = {
                n: [.5, 0, 0, -1],
                e: [1, .5, 1, 0],
        ...
        return function (i) {
            ...
            var F = {}, z = i.dom, W = i.selection, V = new t(z), U = i.schema.isValidChild, q = z.isBlock,
                j = i.settings.forced_root_block, $ = z.nodeIndex, K = "\ufeff", Y = /^(src|href|style)$/, G = !1,
                X = !0, J, Q, Z = z.getContentEditable, et, tt, nt = n.each, rt = n.grep, it = n.walk, ot = n.extend;
            ot(this, {
                get: d,
                register: u,
                apply: m,
        ...
        return function (i) {
            ...
            var a = i.dom, s = i.selection, l = i.settings, c = i.undoManager, d = i.schema,
        ...
        var i = t.makeMap("focusin focusout scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave wheel keydown keypress keyup contextmenu", " "),
            o = {}, a = "onmousewheel" in document, s = !1, l = "mce-", c = e.extend({
                Statics: {elementIdCache: o, classPrefix: l},
                isRtl: function () {
                    return c.rtl
                },
                classPrefix: l,
        ...
        return function (a) {
            ...
            var z = o.each, W = e.BACKSPACE, V = e.DELETE, U = a.dom, q = a.selection, j = a.settings, $ = a.parser,
                K = a.serializer, Y = i.gecko, G = i.ie, X = i.webkit;
        ...
        var E = e.DOM, k = n.ThemeManager, S = n.PluginManager, T = C.extend, R = C.each, A = C.explode, B = C.inArray,
            L = C.trim, D = C.resolve, M = m.Event, H = b.gecko, P = b.ie;
        return N.prototype = {
            render: function () {
                function e() {
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, d, u, f, p, m, h, g, v = [], y, b, C, x, w, _, N, E, k, S, T, R, A, B, L,
                    D, M, H, P, O, I, F, z = Math.max, W = Math.min;
