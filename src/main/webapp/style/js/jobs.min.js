...
$(function () {
    ...
    $("#telForm").validate({
        ...
        groups: {salary: "salaryMin salaryMax"}, onkeyup: !1, focusCleanup: !0, rules: {
            ...
            department: {required: !0, specialchar: !0, maxlenStr: 20},
            jobNature: {required: !0},
            workAddress: {required: !0, maxlenStr: 20},
            salaryMin: {
                required: function () {
            ...
            department: {required: "请输入所属部门", specialchar: "请输入有效的所属部门", maxlenStr: "请输入20字以内的所属部门"},
            ...
            positionAddress: {required: "请输入工作地点"},
            forwardEmail: {
                email: "请输入正确的邮箱格式",
