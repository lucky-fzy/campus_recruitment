                ...
                <form class="layui-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" value="${ad.adName}" id="L_adName" name="adName" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_adDescribe" class="layui-form-label">
                            <span class="x-red">*</span>广告介绍</label>
                        <div class="layui-input-inline">
                            <input type="text" value="${ad.adDescribe}" id="L_adDescribe" name="adDescribe" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        <label for="L_adSite" class="layui-form-label">
                            <span class="x-red">*</span>广告链接</label>
                        <div class="layui-input-inline">
                            <input type="text" value="${ad.adSite}" id="L_adSite" name="adSite" required="" lay-verify="required" autocomplete="off" class="layui-input"></div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-upload">
                            ...
                            <div class="layui-upload-list">
                                <img class="layui-upload-img" id="demo1" src="${ad.adImg}">
                                <p id="demoText"></p>
                            </div>
                        </div>
                        <input type="hidden" value="${ad.adImg}" name="adImg" id="adImg">
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label"></label>
                        <input type="hidden" value="${ad.adId}" name="adId">
                        <button class="layui-btn" lay-filter="edit" lay-submit="" style="display:block;margin:0 auto">修改</button></div>
                </form>
            </div>
        </div>
