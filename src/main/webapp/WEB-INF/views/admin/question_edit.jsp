            ...
            <div class="layui-row">
                <form class="layui-form">
                    ...
                    <div class="layui-form-mid layui-word-aux">
                        ${question.emp.empName}
                    </div>
                </div>
                    <div class="layui-form-item">
                        <label for="L_qname" class="layui-form-label">
                            <span class="x-red">*</span>问题</label>
                        <div class="layui-input-inline">
                            <input style="width: 300px" type="text" id="L_qname" name="questionName" value="${question.questionName}" required="" lay-verify="required" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <span class="x-red">*</span>问题补充</label>
                        <div class="layui-input-inline">
                            <textarea style="width: 300px;height: 100px" name="questionContent">${question.questionContent}</textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <span class="x-red">*</span>提出时间</label>
                        <div class="layui-form-mid layui-word-aux">
        ...
        <script>layui.use(['form', 'layer'],
            function() {
                ...
                function(data) {
                    ...
                    //发异步，把数据提交给后台
                    $.ajax({
                        url:"${APP_PATH}/admin_updateQuestion",
